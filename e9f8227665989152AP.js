            ...
            t.jsxs)(t.Fragment, {
                ...
                t.jsx)("div", {
                    ...
                    t.jsxs)(a.motion.button, {
                        ...
                        className: "text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition duration-300 bg-[#28a745] hover:bg-[#218838] cursor-pointer",
                        children: [C("checking"), "..."]
                    }) : (0,
        ...
        t.jsxs)("div", {
            ...
            t.jsx)("div", {
                ...
                t.jsx)(a.motion.button, {
                    ...
                    className: "text-white mb-2 duration-300 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition bg-[#28a745] hover:bg-[#218838] cursor-pointer",
                    onClick: E,
                    children: c("lblSaveNext")
                })
            })]
        ...
        t.jsxs)(a.motion.div, {
            ...
            t.jsxs)("div", {
                ...
                t.jsx)("button", {
                    onClick: z,
                    disabled: false,
                    className: "text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition bg-[#28a745] hover:bg-[#218838] cursor-pointer",
                        ...
                        t.jsxs)("div", {
                            ...
                            t.jsxs)("div", {
                                ...
                                t.jsx)("button", {
                                    onClick: ej,
                                    disabled: false,
                                    className: "bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-md transition-colors duration-200 hover:bg-green-700 hover:cursor-pointer",
                        ...
                        t.jsxs)("div", {
                            ...
                            t.jsxs)("div", {
                                ...
                                t.jsx)("button", {
                                    onClick: ew,
                                    disabled: false,
                                    className: "bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-md transition-colors duration-300 hover:bg-green-700 hover:cursor-pointer",
                            ...
                            t.jsxs)("div", {
                                ...
                                t.jsxs)("div", {
                                    ...
                                    t.jsx)("button", {
                                        ...
                                        onClick: e_,
                                        disabled: false,
                                        className: "h-10 px-4 text-sm font-medium rounded-md text-white transition-colors duration-300 bg-green-600 hover:bg-green-700 hover:cursor-pointer",
